    ...
    function populateResults(itinerary) {
        ...
        $("#resultsTable").find('tfoot')
            .append($('<tr>')
                ...
                .append($('<td>')
                    .text(totalRow.distance.toLocaleString('en-US'))
                    .attr('align', 'right')
                )
                .append($('<td>')
                    .attr('colspan', 2)
                ...
                .append($('<td>')
                    .text(totalRow.sqm.toLocaleString('en-US'))
                    .attr('align', 'right')
                )
                .append($('<td>')
                    .text(totalRow.sqd.toLocaleString('en-US'))
                    .attr('align', 'right')
                )
                .append($('<td>')
                    .attr('colspan', 2)
                ...
                .append($('<td>')
                    .text(totalRow.totalMiles.toLocaleString('en-US'))
                    .attr('align', 'right')
                )
                .append($('<td>')
                    .attr('colspan', 4)
                ...
                .append($('<td>')
                    .text(totalRow.totalPoints.toLocaleString('en-US'))
                    .attr('align', 'right')
                )
            )
    }
